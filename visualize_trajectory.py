...
读取 minco_trajectory_full.log 文件并可视化轨迹的各种属性：
- XY 平面轨迹
- 速度曲线 (vx vs time)
- 角速度曲线 (omega vs time)
...
def main():
    ...
    用法:
        python3 visualize_trajectory.py              # 使用最新的日志文件
        python3 visualize_trajectory.py <log_file>   # 指定日志文件
    """
    log_file = None
    ...
    print("=" * 60)
    print("MINCO Trajectory Visualization")
    print("=" * 60)
